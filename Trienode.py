class TrieNode:
    def __init__(self):
        ...
        self.is_end_of_word = False  # Boolean to indicate if the node represents the end of a word
        self.product_ids = set()  # Set to store product IDs associated with the node
